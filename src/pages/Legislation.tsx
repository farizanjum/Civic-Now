...
const legislationData = [
  ...
  },
  {
    ...
    summary: "Plan to develop 200 affordable housing units in partnership with local developers, with rent control measures for 10 years.",
    status: "proposed",
    date: "March 28, 2023",
    category: "Housing",
  ...
  },
  {
    ...
    summary: "Creation of a $2M fund to provide grants to small businesses affected by recent economic challenges.",
    status: "passed",
    date: "March 20, 2023",
    category: "Economic Development",
    neighborhoods: ["Downtown", "Westend", "Northside"],
    commentCount: 34,
  },
  {
    id: "leg-005",
    title: "Road Infrastructure Improvement",
    summary: "Comprehensive plan to repair roads, bridges and sidewalks across the city over the next fiscal year.",
    status: "in_review",
    date: "March 15, 2023",
  ...
  {
    id: "leg-006",
    title: "School Nutrition Program Enhancement",
    summary: "Expansion of the school meal program to provide healthy breakfast and lunch options to all public school students.",
    status: "passed",
    date: "March 10, 2023",
    category: "Education",
    neighborhoods: ["Citywide"],
...
type Neighborhood = "Downtown" | "Riverside" | "Northside" | "Westend" | "Eastside" | "Citywide" | "all";
      ...
      <div className="bg-civic-blue/10 py-10">
        <div className="civic-container">
          ...
          <p className="text-lg text-civic-gray-dark mb-6">
            Browse, search and provide feedback on proposed and active legislation in your community.
          </p>
